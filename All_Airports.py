...
class AllAirports:
    def __init__(self) -> None:
        self.airports = None
        self.load_arport_data('./data/airport.csv')

    def load_arport_data(self,file_path):
        airports = {}
        currency_rates = {}
        country_currency = {}
    ...
    def distance_between_two_airports(self,airport1_code,airpirt2_code):
        airport1 = self.airports[airport1_code]
        airport2 = self.airports[airpirt2_code]
